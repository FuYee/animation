...
function win() {
  var winAnimation = animation().loadImage([images]).changePosition($rabbit3, rabbitWinMap, images[2]).repeat(3)
    .then(function () {
...
function lose() {
  var loseAnimation = animation().loadImage([images]).changePosition($rabbit4, rabbitLoseMap, images[1]).repeat(1)
    .then(function () {
